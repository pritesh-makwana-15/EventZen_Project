        ...
        registrations.map(async (reg) => {
          try {
            ...
            return {
              ...reg,
              event: eventResponse.data,
              // ✅ FIXED: Don't add ticketId - backend doesn't return it in RegistrationResponse
              // hasTicket is already in the response from backend
            };
          } catch (err) {
            console.error(`Error loading event ${reg.eventId}:`, err);
            return null;
